...
const INITIAL_ABOUT: AboutContent = {
  ...
  description: '1996 সাল থেকে আমরা মিষ্টির জগতে শুদ্ধতা ও ঐতিহ্যের স্বাক্ষর রেখে আসছি। আমাদের প্রতিটি মিষ্টি তৈরির পেছনে রয়েছে বছরের পর বছর ধরে অর্জিত অভিজ্ঞতা এবং খাঁটি উপকরণের ভালোবাসা।',
  years_legacy: '26 বছরের ঐতিহ্য',
...
const INITIAL_SETTINGS: SiteSettings = {
  ...
  hero_subtitle: 'স্বাদ ও ঐতিহ্যের এক অপূর্ব মিলনমেলা। 1996 সাল থেকে আমরা আপনাদের সেবায় নিয়োজিত।',
